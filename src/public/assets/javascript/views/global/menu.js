define([
...
], function($, _, Backbone, Mustache, Spinner, Menu, SidebarView) {
    ...
    var MenuView = Backbone.View.extend({
        ...
        template: '[data-tornado-template="main-menu"]',
        ...
        render: function (controller) {
            // render the template
            var template = Mustache.render($(this.template).html(), this.model.attributes);
            ...
            this.$el.attr('data-main-menu-worksheet-type', this.model.get('worksheet').chart_type || 'default');
