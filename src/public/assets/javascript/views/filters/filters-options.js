define([
    ...
    var FiltersOptionsView = View.extend({
        ...
        template: '[data-tornado-template="filters-options"]',
        ...
        timeSliderOptions: function() {
            ...
            if (this.data.analysis === 'timeSeries') {
                options = this.adjustTimeSpans(this.data.timeInterval, this.data.timeSpan, options.from, options.to);
            }
        ...
        render: function() {
            ...
            template = Mustache.render(template, this.data.filters);
