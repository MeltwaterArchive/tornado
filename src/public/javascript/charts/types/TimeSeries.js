...
define(['d3', 'trace', 'moment'],
function(d3, Trace, moment) {
    'use strict';
    ...
    var TimeSeries = function(options) {
        Trace.lineChart.call(this, this._extend({
            showx: true,
            showy: true,
            showpoints: false,
            interpolate: 'linear',
     ...
     * @type {Trace}
     */
    TimeSeries.prototype = Object.create(Trace.lineChart.prototype);
    ...
    TimeSeries.prototype._draw = function() {
        ...
        if (this.options.brush) {
            ...
            brush.on('brushend', function() {
                ...
                extent = brush.extent();
                exploreName = moment(extent[0]).format('lll') + ' - ' + moment(extent[1]).format('lll');
