define(['jquery', 'backbone', 'mustache', 'spinner', 'loader', 'tooltip', 'contextmenu', 'modallica', 'views/global/menu', 'plugins/dropdown-toggle'],
function($, Backbone, Mustache, Spinner, Loader, Tooltip, ContextMenu, Modallica, Menu, DropdownToggle) {
    'use strict';
