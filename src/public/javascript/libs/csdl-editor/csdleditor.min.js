...
CSDLEditor.Loader.addComponent(function(jQuery) {
 ...
 */
/*global CSDLEditor, Math*/
(function(CSDLEditor, Math, window, document, undefined) {
...
})(CSDLEditor, Math, window, document);
...
(function(CSDLEditor, window, undefined) {
    ...
    // don't register if not HTML 5 and fallback to jQuery UI
    // @DataSift Code Editor
    var div = document.createElement('div');
    if (!('draggable' in div || ('ondragstart' in div && 'ondrop' in div))) {
        return;
